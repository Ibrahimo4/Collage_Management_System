...
{
    public partial class frmHostelFeePaymentRecord1 : Form
    {
        ...
        public frmHostelFeePaymentRecord1()
        {
            InitializeComponent();
        }
        ...
        private void frmHostelFeePaymentRecord_Load(object sender, EventArgs e)
        {
            AutocompleteCourse();
        ...
        private void button12_Click(object sender, EventArgs e)
        {
             try
            {
                ...
                con.Open();
                cmd = new SqlCommand("select RTrim(HFeePaymentID)[Fee Payment ID], RTRIM(Student.ScholarNo)[Scholar No.],RTRIM(Student_name)[Student Name],RTRIM(Student.Course)[Course],RTRIM(Branch)[Branch],RTRIM(Hostel.HostelName)[Hostel Name],RTRIM(HostelFeePayment.HostelFees)[Hostel Fees],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees]  from HostelFeePayment,Student,Hostel,Hostelers where Student.scholarNo=Hostelers.ScholarNo and HostelFeePayment.ScholarNo=Student.ScholarNo and Hostel.HostelName=Hostelers.Hostelname and DateOfPayment between @date1 and @date2 and DueFees > 0 order by DateOfPayment", con);
        ...
        private void ScholarNo_SelectedIndexChanged(object sender, EventArgs e)
        {
             try
            {
                ...
                con.Open();
                cmd = new SqlCommand("select RTrim(HFeePaymentID)[Fee Payment ID], RTRIM(Student.ScholarNo)[Scholar No.],RTRIM(Student_name)[Student Name],RTRIM(Student.Course)[Course],RTRIM(Branch)[Branch],RTRIM(Hostel.HostelName)[Hostel Name],RTRIM(HostelFeePayment.HostelFees)[Hostel Fees],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees]  from HostelFeePayment,Student,Hostel,Hostelers where Student.scholarNo=Hostelers.ScholarNo and HostelFeePayment.ScholarNo=Student.ScholarNo and Hostel.HostelName=Hostelers.Hostelname and Student.ScholarNo = '" + ScholarNo.Text + "' order by DateOfPayment", con);
        ...
        private void button10_Click(object sender, EventArgs e)
        {
             try
            {
                ...
                con.Open();
                cmd = new SqlCommand("select RTrim(HFeePaymentID)[Fee Payment ID], RTRIM(Student.ScholarNo)[Scholar No.],RTRIM(Student_name)[Student Name],RTRIM(Student.Course)[Course],RTRIM(Branch)[Branch],RTRIM(Hostel.HostelName)[Hostel Name],RTRIM(HostelFeePayment.HostelFees)[Hostel Fees],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees]  from HostelFeePayment,Student,Hostel,Hostelers where Student.scholarNo=Hostelers.ScholarNo and HostelFeePayment.ScholarNo=Student.ScholarNo and Hostel.HostelName=Hostelers.Hostelname and DateOfPayment between @date1 and @date2 order by DateOfPayment", con);
        ...
        private void button14_Click(object sender, EventArgs e)
        {
             try
            {
                ...
                con.Open();
                cmd = new SqlCommand("select RTrim(HFeePaymentID)[Fee Payment ID], RTRIM(Student.ScholarNo)[Scholar No.],RTRIM(Student_name)[Student Name],RTRIM(Student.Course)[Course],RTRIM(Branch)[Branch],RTRIM(Hostel.HostelName)[Hostel Name],RTRIM(HostelFeePayment.HostelFees)[Hostel Fees],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees]  from HostelFeePayment,Student,Hostel,Hostelers where Student.scholarNo=Hostelers.ScholarNo and HostelFeePayment.ScholarNo=Student.ScholarNo and Hostel.HostelName=Hostelers.Hostelname and DateOfPayment between @date1 and @date2 and Fine > 0 order by DateOfPayment", con);
        ...
        private void frmHostelFeePaymentRecord_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.Hide();
            frmHostelFeePayment frm = new frmHostelFeePayment();
            frm.label3.Text = label13.Text;
