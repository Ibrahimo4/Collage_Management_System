...
{
    public partial class frmHostelersRecord1 : Form
    {
        ...
        private void frmHostelersRecord_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.Hide();
