...
{
    public partial class frmFeePaymentRecord : Form
    {
        ...
        private void dataGridView1_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
                ...
                frm.FeeID.Text = dr.Cells[5].Value.ToString();
                frm.FDCourse.Text = dr.Cells[3].Value.ToString();
                frm.FDBranch.Text = dr.Cells[4].Value.ToString();
                frm.Semester.Text = dr.Cells[6].Value.ToString();
                frm.TutionFees.Text = dr.Cells[7].Value.ToString();
                frm.LibraryFees.Text = dr.Cells[8].Value.ToString();
                frm.UDFees.Text = dr.Cells[9].Value.ToString();
                frm.USFees.Text = dr.Cells[10].Value.ToString();
                frm.CautionMoney.Text = dr.Cells[11].Value.ToString();
                frm.OtherFees.Text = dr.Cells[12].Value.ToString();
                frm.TotalFees.Text = dr.Cells[13].Value.ToString();
                frm.PaymentDate.Text = dr.Cells[14].Value.ToString();
                frm.ModeOfPayment.Text = dr.Cells[15].Value.ToString();
                frm.PaymentModeDetails.Text = dr.Cells[16].Value.ToString();
                frm.TotalPaid.Text = dr.Cells[17].Value.ToString();
                frm.Fine.Text = dr.Cells[18].Value.ToString();
                frm.DueFees.Text = dr.Cells[19].Value.ToString();
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("select RTrim(FeePaymentID)[Fee Payment ID],RTrim(FeePayment.ScholarNo)[Scholar No.], RTRIM(Student.Student_Name)[Student Name],RTRIM(Student.Course)[Course],RTRIM(Student.Branch)[Branch],RTRIM(FeeID)[Fee ID],RTRIM(Semester)[Semester],RTRIM(TutionFees)[Tution Fess],RTRIM(LibraryFees)[Library Fees],RTRIM(UniversityDevelopmentFees)[Univ. Development Fees],RTRIM(UniversityStudentWelfareFees)[University Student Welfare],RTRIM(CautionMoney)[Caution Money],RTRIM(OtherFees)[OtherFees],RTRIM(TotalFees)[Total Fees],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees]  from FeePayment,Student where Student.ScholarNo=Feepayment.scholarNo and DateOfPayment between @date1 and @date2 and Student.Course= '" + Course.Text + "'and Student.branch='" + Branch.Text + "' order by DateOfPayment", con);
