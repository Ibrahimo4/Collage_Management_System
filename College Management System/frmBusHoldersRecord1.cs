...
{
    public partial class frmBusHoldersRecord1 : Form
    {
        ...
        private void frmBusHoldersRecord1_Load(object sender, EventArgs e)
        {
            AutocompleteCourse();
            AutocompleteScholarNo();
            AutocompleteSourceLocation();
        ...
        private void frmBusHoldersRecord1_FormClosing(object sender, FormClosingEventArgs e)
        {
